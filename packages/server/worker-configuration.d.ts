/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 79df3908592950d1417a54e130db42ec)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	APP_URL: "https://10-pow-100-maps.vercel.app";
	BLUEMAP_URL: "http://server.mrjulsen.de:8100";
	BLUEMAP_WORLD: "world";
	DISCORD_ID: "1526337278866231417";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "BLUEMAP_URL" | "BLUEMAP_WORLD" | "DISCORD_ID" | "DISCORD_SECRET">> {}
}
